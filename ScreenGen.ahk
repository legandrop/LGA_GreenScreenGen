...
GenerateImages:
    ...
    Loop, % imageNames.MaxIndex()
    {
        ...
        if (hasTracking)
        {
            ...
            filter .= ",drawtext=fontfile=/Windows/Fonts/arial.ttf:text='●':fontcolor=" . trackColor . ":fontsize=" . fontSize . ":x=" . margin . ":y=" . margin
            ; Esquina superior derecha
            filter .= ",drawtext=fontfile=/Windows/Fonts/arial.ttf:text='●':fontcolor=" . trackColor . ":fontsize=" . fontSize . ":x=" . width-margin . "-tw:y=" . margin
            ; Esquina inferior izquierda
            filter .= ",drawtext=fontfile=/Windows/Fonts/arial.ttf:text='●':fontcolor=" . trackColor . ":fontsize=" . fontSize . ":x=" . margin . ":y=" . height-margin . "-th"
            ; Esquina inferior derecha
            filter .= ",drawtext=fontfile=/Windows/Fonts/arial.ttf:text='●':fontcolor=" . trackColor . ":fontsize=" . fontSize . ":x=" . width-margin . "-tw:y=" . height-margin . "-th"
            ; Centro
            filter .= ",drawtext=fontfile=/Windows/Fonts/arial.ttf:text='●':fontcolor=" . trackColor . ":fontsize=" . fontSize . ":x=(w-tw)/2:y=(h-th)/2"

            ffmpegCommand .= " -vf """ . SubStr(filter, 2) . """"
        }
