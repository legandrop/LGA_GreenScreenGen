...
GenerateImages:
    ...
    Loop, % imageNames.MaxIndex()
    {
        ...
        errorLog := logsDir . "\" . imageName . "_error.log" ; Cambiado para usar la carpeta de logs
        outputLog := logsDir . "\" . imageName . "_output.log" ; Cambiado para usar la carpeta de logs
        ...
        ; 4. Definir 'chcp 65001' al inicio del archivo de lote
